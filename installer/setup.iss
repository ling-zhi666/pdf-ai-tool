...
#define MyAppURL "https://github.com/username/pdf-ai-tool"
...
[Files]
Source: "dist\PDF-AI-Tool\*"; DestDir: "{app}"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
